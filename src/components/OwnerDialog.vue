    ...
    <v-card>
      ...
      <v-card-text style="text-align: center">
        ...
        <v-col style="height: 100%; padding-bottom: 5px" xs12 sm12 md12>
          <v-text-field v-model="menu" placeholder="예) 황올 후라이드 치킨" label="메뉴" persistent-hint></v-text-field>
          <v-checkbox v-model="sunsal" label="순살?"></v-checkbox>

          <v-text-field v-model="price" placeholder="예) 1" label="가격 (ETH)" persistent-hint></v-text-field>
        </v-col>
        <v-col style="height: 100%; padding-bottom: 5px" xs12 sm12 md12>
