<template>
  <v-app>
    <v-toolbar dark color="primary">
      <v-toolbar-title class="titleText">User My Page</v-toolbar-title>
      <v-spacer></v-spacer>
    </v-toolbar>
    <!-- 페이지 이름 -->
        ...
        >
          <v-card>
            <v-row justify="space-around" class="mb-2">
              &nbsp; &nbsp; &nbsp; &nbsp;
              <v-chip class="ma-2" color="green" label text-color="white" x-large>
                <v-icon size="30" right>mdi-home</v-icon>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <span class="matching">
                  방번호 &nbsp; :&nbsp;
                  {{ orderedLists1.roomNumber
                  }}{{ orderedLists2.roomNumber }}
                </span>
              </v-chip>
              <v-spacer></v-spacer>
          ...
          <v-card-actions>
            <v-row justify="space-around" class="mb-2">
              <v-spacer></v-spacer>
              <v-btn class="ma-2 text-h4" color="orange" @click="deleteOrderRoom">
              ...
              <v-btn class="ma-2 text-h4" color="orange" @click="getStateRoom">
                <v-icon left>mdi-cancel</v-icon>
                <span>테스트2</span>
              </v-btn>
            </v-row>
    ...
    <v-container>
      ...
      >
        <!-- <div id="app"> -->
        <!-- <v-app id="inspire"> -->
        <v-data-table :headers="headers" :items="orderedLists3" class="elevation-1">
